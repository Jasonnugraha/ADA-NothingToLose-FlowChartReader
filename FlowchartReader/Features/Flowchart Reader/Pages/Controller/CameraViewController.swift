...
//
//    var flowchartDetail: [FlowchartDetail]?
//
//
...
//
//        if let flowchartComponents = flowchartComponents, let textComponents = textComponents {
//            flowchartDetail = FlowchartDetailService().getFlowchartDetails(flowchartComponents: flowchartComponents, textComponents: textComponents)
//        }
//
